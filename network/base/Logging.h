...
#define CRITICAL Critical() << "[" << __FILE__ << " line:" << __LINE__ << "]"
#define WARNING Warning() << "[" << __FILE__ << " line:" << __LINE__ << "]"
#define FATAL Fatal() << "[" << __FILE__ << "line:" << __LINE__ << "]"
#define TRACE Debug() << "[" << __FILE__ << " line:" << __LINE__ << "]"
